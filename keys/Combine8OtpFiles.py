...
with open(sys.argv[1]+'.txt', 'rb') as input1, open(sys.argv[2]+'.txt', 'rb') as input2, sys.argv[3]+'.txt', 'rb') as input3, open(sys.argv[4]+'.txt', 'rb') as input4, sys.argv[5]+'.txt', 'rb') as input5, open(sys.argv[6]+'.txt', 'rb') as input6, sys.argv[7]+'.txt', 'rb') as input7, open(sys.argv[8]+'.txt', 'rb') as input8, open('output.bin', 'wb') as output:
